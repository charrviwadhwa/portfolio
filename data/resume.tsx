  ...
  education: [
    {
      ...
      href: "https://msit.in",
      degree: "Bachelor's Degree of Technology (BTech) in Information Technology",
      logoUrl: "/msit.png",
      start: "2023",
      end: "2027",
    },
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "GitPeek is an AI-powered tool designed to help developers instantly understand any public GitHub repository—even those without a README. It analyzes code and metadata to generate clear, readable summaries, saving time and effort for devs exploring unfamiliar projects.",
      technologies: [
        "React.js",
        "JavaScript",
        "Node.js",
